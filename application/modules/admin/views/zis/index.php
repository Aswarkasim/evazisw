                        ...
                        <tbody id="targetData">
                            ...
                            foreach ($zis as $row) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#ModalEdit<?= $row->id_zis ?>">
                                            <i class="fa fa-edit"></i>
                                        </button>

                                        <!-- <a href="<?= base_url($tombol['edit']) ?>" class="btn btn-success btn-xs"><i class="fa fa-edit"></i> Edit</a> -->
                                        <a href="<?= base_url($tombol['delete'] . $row->id_zis) ?>" class="btn btn-danger btn-xs tombol-hapus"><i class="fa fa-trash"></i></a>
                                    </td>
